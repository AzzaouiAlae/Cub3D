SRC = main.c \
  		ft_func/ft_strchr.c ft_func/ft_atoi.c	ft_func/ft_close.c	ft_func/ft_itoa.c	ft_func/ft_memcpy.c	ft_func/ft_open.c	ft_func/ft_putstr_fd.c	ft_func/ft_split.c	ft_func/ft_strdup.c	ft_func/ft_strjoin.c	ft_func/ft_strlcat.c	ft_func/ft_strlen.c	ft_func/ft_strncmp.c	ft_func/ft_strnstr.c	ft_func/ft_substr.c \
		...
		map_game/map_game.c player/player.c raycasting/raycasting.c

OBJ =  main.o \
  		ft_func/ft_strchr.o ft_func/ft_atoi.o	ft_func/ft_close.o	ft_func/ft_itoa.o	ft_func/ft_memcpy.o	ft_func/ft_open.o	ft_func/ft_putstr_fd.o	ft_func/ft_split.o	ft_func/ft_strdup.o	ft_func/ft_strjoin.o	ft_func/ft_strlcat.o	ft_func/ft_strlen.o	ft_func/ft_strncmp.o	ft_func/ft_strnstr.o	ft_func/ft_substr.o \
		...
		map_game/map_game.o player/player.o raycasting/raycasting.o
